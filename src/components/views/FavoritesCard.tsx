...
import star_blue_yellow_svg_element from "../../img/icon/star_blue-yellow.svg"


// const star_blue_yellow_svg_element = 
// (
//     <svg width="1.85rem" height="1.6rem" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
