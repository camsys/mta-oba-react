...
//             </span>
//             <span className="add" style={favorited?{display:'none'}:undefined}>Add Route to Favorites</span>
//             <span className="remove" style={favorited?undefined:{display:'none'}}>Remove Route from Favorites</span>
//         </button>
//     </React.Fragment>)
// }
