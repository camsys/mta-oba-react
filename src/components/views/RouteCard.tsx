            ...
            <ul className="menu icon-menu card-menu">
                <li>
                    <button className="favorite-toggle" tabIndex="0" aria-label='Toggle favorites status for this stop'>
                        ...
                        <span className="add" onClick={()=>addFavorite(routeMatch)}>Add Route to Favorites</span>
                        <span className="remove" style={{ display: 'none'}} onClick={()=>removeFavorite(routeMatch)}>Remove Route from Favorites</span>
                    </button>
                </li>
            </ul>
        </React.Fragment>)
