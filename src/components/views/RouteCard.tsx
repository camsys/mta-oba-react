            ...
            <ul className="menu icon-menu card-menu">
                <li>
                    <button className="favorite-toggle" tabIndex="0" aria-label='Toggle favorites status for this stop'>
                        ...
                        <span className="add" onClick={()=>addFavorite(routeMatch)}>Add Stop to Favorites</span>
                        <span className="remove" style={{ display: 'none'}} onClick={()=>removeFavorite(routeMatch)}>Remove Stop from Favorites</span>
                    </button>
                </li>
            </ul>
        </React.Fragment>)
