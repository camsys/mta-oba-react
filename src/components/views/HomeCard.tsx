...
function HomeCard  () : JSX.Element {
    ...
    <ul>
        <li>Route:
            <ul className="links">
                <li><a href="javascript:void(0)" onClick={() => search('B63')}>B63</a></li>
                <li><a href="javascript:void(0)" onClick={() => search( 'M5')}>M5</a></li>
                <li><a href="javascript:void(0)" onClick={() => search( 'Bx1')}>Bx1</a></li>
            </ul>
        </li>
        <li>Intersection:
            <ul className="links">
                <li><a href="javascript:void(0)" onClick={() => search('Main st and Kissena Bl')}>Main st and Kissena Bl</a></li>
            </ul>
        </li>
        <li>Stop Code:
            <ul className="links">
                <li><a href="javascript:void(0)" onClick={() => search('200884')}>200884</a></li>
            </ul>
        </li>
    </ul>
    <ul className="menu icon-menu" role="menu">
        <li>
            <a href="javascript:void(0)" onClick={()=>allRoutesSearch()}>
