        ...
        <div className="inner-card route-direction en-route collapsible open">
            ...
            <div className="card-content collapse-content">
                ...
                <ul className="menu icon-menu inner-card-menu">
                    <li>
                        <ViewSearchItem datumId={routeDirectionDatum.routeId} text={"Full Route"}/>
                    </li>
                </ul>
            </div>
        </div>
...
export function StopCardFavoriteButton({stopMatch}:StopMatch):JSX.Element{
    ...
    <div className={`card stop-card ${oneOfMany?"collapsible open":""} ${isFavorite(stopMatch)?"favorite":""}`}>
        ...
        <div className="card-content collapse-content">
            ...
            <ul className="menu icon-menu card-menu">
                ...
                <li>
                    <ViewSearchItem datumId={stopMatch.id} text={"Stop"}/>
                </li>
            </ul>
        </div>
    </div>
