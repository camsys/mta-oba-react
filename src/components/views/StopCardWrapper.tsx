        ...
        <div className="inner-card route-direction en-route collapsible open">
            ...
            <div className="card-content collapse-content">
                ...
                <ul className="menu icon-menu inner-card-menu">
                    <li>
                        <button className="favorite-toggle" tabIndex="0" aria-label='Toggle favorites status for this stop' onClick={() => search(routeDirectionDatum.routeId.split("_")[1])}>
...
export function StopCardContent({stopMatch}: StopMatch):JSX.Element{
    ...
    let {addFavorite,removeFavorite} = useFavorite();
    return(
        <React.Fragment>
            ...
            <ul className="menu icon-menu card-menu">
                <li>
                    <button className="favorite-toggle" tabIndex="0" aria-label='Toggle favorites status for this stop'>
                        ...
                        <span className="add" onClick={()=>addFavorite(stopMatch)}>Add Stop to Favorites</span>
                        <span className="remove" style={{ display: 'none'}} onClick={()=>removeFavorite(stopMatch)}>Remove Stop from Favorites</span>
                    </button>
                </li>
                {/* <li>
