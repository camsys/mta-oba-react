    ...
    return (
        <ErrorBoundary>
            <div id="search" onKeyDown={(event) => {
                ...
                <div className={`font-normal search-box${isFocused ? ' is-focused' : ''}`}>
                    <span className="flex absolute inset-0 h-full justify-center items-center w-[2.25em]" aria-hidden="true">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none"><g clip-path="url(#a)"><path fill="#fff" d="m19.688 18.192-5.549-5.549a7.775 7.775 0 0 0 1.615-4.75 7.876 7.876 0 1 0-3.11 6.254l5.548 5.549a1.07 1.07 0 0 0 1.496 0 1.062 1.062 0 0 0 0-1.504ZM2.158 7.893a5.735 5.735 0 1 1 5.736 5.736 5.744 5.744 0 0 1-5.735-5.736Z"/></g><defs><clipPath id="a"><path fill="#fff" d="M0 0h20v20H0z"/></clipPath></defs></svg>
                    </span>
                    <Autosuggest
