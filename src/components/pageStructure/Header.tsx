...
function Header  () {
    ...
    return (
        <ErrorBoundary>
            {state.currentCard.type === CardType.HomeCard && bannerText && bannerLink && (
            ...
            <header className="header pt-2 pb-3" id="header">
                ...
                <a href="https://www.mta.info/" target="_blank" rel="noreferrer" aria-label="MTA Home" className=" bottom flex mta-logo-link justify-end items-end focus-visible:border-mta-yellow border-b-3 border-transparent">
