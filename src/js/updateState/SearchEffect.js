...
function _getData() {
  _getData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(card, stops, routes) {
    var address;
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        ...
        case 4:
          address = "https://" + process.env.ENV_ADDRESS + "/" + _oba.OBA.Config.searchUrl + "?q=" + card.searchTerm; // let address = "http://localhost:8080" + "/" + OBA.Config.searchUrl + "?q=" + card.searchTerm
...
var updateCard = exports.updateCard = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(searchRef, stops, routes) {
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 3;
          return getData(new _DataModels.Card(searchRef), stops, routes);
        case 3:
...
var useSearch = exports.useSearch = function useSearch() {
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.next = 10;
            return updateCard(searchTerm, stops, routes);
          case 10:
  ...
  var generateInitialCard = /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(setLoading) {
      var searchRef, currentCard, cardStack;
    ...
    return function generateInitialCard(_x8) {
  ...
  var vehicleSearch = /*#__PURE__*/function () {
    ...
    return function vehicleSearch(_x9) {
